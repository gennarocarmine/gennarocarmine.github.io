...
{%- comment -%}
==========================================================================
POSTS SEARCH - Commentato perché i post non sono ancora stati aggiunti.
  Decommentare quando si aggiungono i post al sito.
==========================================================================
{%- endcomment -%}
{%- comment -%}
...
{%- comment -%}
==========================================================================
COLLECTIONS SEARCH (news, teaching, books, projects, ecc.)
Commentato perché le collezioni non sono ancora state aggiunte.
  Decommentare quando si aggiungono news, teaching, books, projects al sito.
==========================================================================
{%- endcomment -%}
{%- comment -%}
...
{%- comment -%}
==========================================================================
THEME SEARCH - Commentato perché i temi non sono ancora stati aggiunti.
  Decommentare quando si abilita il dark mode nel sito.
==========================================================================
{%- endcomment -%}
{%- comment -%}
